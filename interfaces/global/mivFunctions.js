...
//dump("-."+aString+".-\n\n");
	...
	{
		let html;
		html = this.htmlspecialchars(aString, 1, null, true)
		return '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head><body>'+html+'</body></html>';
	},

	// Original code from locutus.io
	// License: MIT
	// Source: https://raw.githubusercontent.com/kvz/locutus/master/src/php/strings/htmlspecialchars.js
	htmlspecialchars: function _htmlspecialchars(string, quoteStyle, charset, doubleEncode)
	{
